 ...
 */
static char *font = "boxxy:pixelsize=16:antialias=true:autohint=true";
static char *font2[] = { "TerminessTFF Nerd Font Mono:pixelsize=16:antialias=true:autohint=true" };
